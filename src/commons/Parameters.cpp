...
Parameters::Parameters():
        ...
        PARAM_EDGE_BONUS_RATIO(PARAM_EDGE_BONUS_RATIO_ID, "--edge-bonus-ratio", "Start/End exons bonus ratio", "ratio for bonus score for start/end exons x%", typeid(int), &edgeBonusRatio, "^[0-9]*$"),
        //edgeBonusRatio
